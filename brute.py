...
def banner():
  os.system("clear")
  print("\n\n")
  os.system("figlet -f slant DARK-NET |lolcat")
  print(lines)
  print("""
   Tools Name   : \033[1;32mFacebook ID Bruteforcer\033[1;37m
   Tools Author : \033[1;32mARIYAN RABBI\033[1;37m
   Github       : \033[1;32mgithub.com/DARK-NET-604\033[1;37m
   Facebook     : \033[1;32mARIYAN RABBY\033[1;37m
  """)
  print(lines)
  upass=input("\n   [•] Enter Tool's Password: ")
  if upass=="DARK-NET" or upass == "DARK-NET" or upass == "DARK-NET" or upass == "DARK-NET":
    ...
    print(lines)
    slow("   [•] Password Wrong")
    slow("   [•] Follow My Facebook id For Password")
    
    os.system("xdg-open https://www.facebook.com/DARK.NET.604?mibextid=ZbWKwL")
    print(lines)
    sys.exit()
  menu()
def mbanner():
  ...
  print("""
   Tools Name   : \033[1;32mFacebook ID Bruteforcer\033[1;37m
   Tools Author : \033[1;32mARIYAN RABBI\033[1;37m
   Github       : \033[1;32mgithub.com/DARK-NET\033[1;37m
   Facebook     : \033[1;32mARIYAN RABBI\033[1;37m
  """)
def menu():
  print(lines)
...
def choose():
  ...
  if a=="1" or a=="01":
    ...
    os.system("xdg-open https://t.me/dark_net12")
    sys.exit()
  elif a=="4" or a=="04":
    os.system("xdg-open https://github.com/DARK-NET-604?tab=repositories")
    sys.exit()
  elif a=="5" or a=="05":
    print(lines)
